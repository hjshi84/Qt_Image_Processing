...
QT_MOC_LITERAL(5, 21, 4)
    ...
    "mythread\0notify\0\0a\0b\0stop\0"
};
...
void mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->notify((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< QImage(*)>(_a[2]))); break;
        case 1: _t->notify((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        ...
        {
            typedef void (mythread::*_t)(QImage , QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mythread::notify)) {
                *result = 0;
            }
        }
        {
...
// SIGNAL 0
void mythread::notify(QImage _t1, QImage _t2)
{
...
// SIGNAL 1
void mythread::notify(QImage _t1)
{
